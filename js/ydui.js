...
function(window) {
    ...
    CitySelect.prototype.open = function() {
        ...
        _this.$mask.on('click.ydui.cityselect.mask',
        function() {
            _this.close();
        });
    ...
    CitySelect.prototype.createDOM = function() {
        ...
        _this.$cityElement.on('click.ydui.cityselect', '.cityselect-nav a',
        function() {
            var $this = $(this);
    ...
    CitySelect.prototype.bindItemEvent = function() {
        ...
        $cityElement.on('click.ydui.cityselect', '.cityselect-item-box a',
        function() {
            var $this = $(this);
